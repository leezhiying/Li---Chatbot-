...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 16:53:46 2019
...
class CornellWordChatBot(object):
    ...
    def __init__(self):
        ...
        decoder_lstm = LSTM(units=HIDDEN_UNITS*2, return_sequences=True, return_state=True, name='decoder_lstm')
        ...
        self.model.load_weights('models/word-weights_BLSTM.h5')
...
for i in range(len(input_texts)-1):
    ...
    s = sentence_bleu(truth,reply,weights = (1,1,0,0))
    print(s)
    score += s 

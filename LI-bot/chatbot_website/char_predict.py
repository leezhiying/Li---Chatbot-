...
class CornellCharChatBot(object):
    ...
    def __init__(self):
        self.input_char2idx = np.load('models/char-lstm/char-input-char2idx.npy').item()
        print(self.input_char2idx)
        self.input_idx2char = np.load('models/char-lstm/char-input-idx2char.npy').item()
        self.target_char2idx = np.load('models/char-lstm/char-target-char2idx.npy').item()
        self.target_idx2char = np.load('models/char-lstm/char-target-idx2char.npy').item()
        context = np.load('models/char-lstm/char-context.npy').item()
        ...
        #model_json = open('models/cornell/char-architecture.json', 'r').read()
        #self.model = model_from_json(model_json)
        self.model.load_weights('models/char-lstm/char-weights.h5')
